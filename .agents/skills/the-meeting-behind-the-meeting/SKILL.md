...
For Codex, route by workflow and evidence level, not Claude model switching. When editing this repository, do not skip test gates.
...
- Quality template: `templates/00-quality-assessment.md`
...
Use `resources/book-summaries/` as supporting lenses; do not quote long sections, do not reproduce book content in outputs, and convert reference material into evidence-based analysis.
